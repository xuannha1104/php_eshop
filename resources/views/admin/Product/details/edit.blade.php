        ...
        <div class="row">
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <form method="post" action="{{route('ProductDetailsUpdate',$productDetail->id)}}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="qty" id="qty" placeholder="Quantity" type="text"
                            ...
                            <div class="position-relative row form-group mb-1">
                                <div class="col-md-9 col-xl-8 offset-md-2">
                                    <a href="{{route('ProductDetailsManager',$product->id)}}" class="border-0 btn btn-outline-danger mr-1">
