...
@section('title','Product Details Creation')
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="main-card mb-3 card">
                        <div class="card-body">
                            <form method="post" action="{{route('ProductDetailsStore',$parentProduct->id)}}" enctype="multipart/form-data">
                                @csrf
                                <div class="position-relative row form-group">
                                    ...
                                    <div class="col-md-9 col-xl-8">
                                        <input disabled placeholder="Product Name" type="text"
                                            class="form-control" value="{{$parentProduct->name}}">
                                    </div>
                                </div>
                                ...
                                <div class="position-relative row form-group mb-1">
                                    <div class="col-md-9 col-xl-8 offset-md-2">
                                        <a href="{{route('ProductDetailsManager',$parentProduct->id)}}" class="border-0 btn btn-outline-danger mr-1">
