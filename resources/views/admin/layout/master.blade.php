                            ...
                            <div class="dropdown-menu-header">
                                <div class="dropdown-menu-header-inner bg-secondary">
                                    <div class="menu-header-image opacity-5"
                                         style="background-image: url('/public/dashboard/assets/images/dropdown-header/abstract2.jpg');">
                                    </div>
                            ...
                            <div class="dropdown-menu-header">
                                <div class="dropdown-menu-header-inner bg-success">
                                    <div class="menu-header-image opacity-1"
                                         style="background-image: url('/public/dashboard/assets/images/dropdown-header/abstract3.jpg');">
                                    </div>
                            ...
                            <div class="dropdown-menu-header">
                                <div class="dropdown-menu-header-inner bg-plum-plate">
                                    <div class="menu-header-image"
                                         style="background-image: url('/public/dashboard/assets/images/dropdown-header/abstract4.jpg');">
                                    </div>
                        ...
                        <div tabindex="-1" role="menu" aria-hidden="true"
                            ...
                            <div class="dropdown-menu-header mb-0">
                                <div class="dropdown-menu-header-inner bg-deep-blue">
                                    <div class="menu-header-image opacity-1"
                                         style="background-image: url('/public/dashboard/assets/images/dropdown-header/city3.jpg');">
                                    </div>
                            ...
                            <div class="dropdown-menu-header">
                                <div class="dropdown-menu-header-inner pt-4 pb-4 bg-focus">
                                    <div class="menu-header-image opacity-05"
                                         style="background-image: url('/public/dashboard/assets/images/dropdown-header/city2.jpg');">
                                    </div>
                    ...
                    <div class="widget-content p-0">
                        <div class="widget-content-wrapper">
                            ...
                            <div class="widget-content-left  ml-3 header-user-info">
                                <div class="widget-heading"> {{Auth::user()->name}} </div>
                                <div class="widget-subheading"> {{\App\Ultities\Constants::$user_level[Auth::user()->level]}} </div>
                            </div>
                ...
                <div class="app-sidebar__inner">
                    <ul class="vertical-nav-menu">
                        ...
                        <li class="mm-active">
                            ...
                            <ul>
                                <li>
                                    <a href="{{route('UserManager')}}" class="{{(request()->segment(2)=='user') ? 'mm-active' : '' }}">
                                ...
                                <li>
                                    <a href="{{route('ProductManager')}}" class="{{(request()->segment(2) == 'product') ? 'mm-active' : '' }}">
                                        <i class="metismenu-icon"></i>Product
                                    </a>
                                </li>
                                <li>
                                    <a href="{{route('CategoryManager')}}" class="{{(request()->segment(2) == 'category') ? 'mm-active' : '' }}">
                                        <i class="metismenu-icon"></i>Category
                                    </a>
                                </li>
                                <li>
                                    <a href="{{route('BrandManager')}}" class="{{(request()->segment(2)=='brand') ? 'mm-active' : '' }}">
                                        ...
                                        <div class="d-none popover-custom-content">
                                            <div class="dropdown-menu-header">
                                                <div class="dropdown-menu-header-inner bg-tempting-azure">
                                                    <div class="menu-header-image opacity-1"
                                                         style="background-image: url('/public/dashboard/assets/images/dropdown-header/city5.jpg');">
                                                    </div>
                                                    <div class="menu-header-content text-dark">
