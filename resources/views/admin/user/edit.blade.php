                            ...
                            <form method="post" action="admin/user/edit/{{$user->id}}" enctype="multipart/form-data">
                                ...
                                <div class="position-relative row form-group">
                                    ...
                                    <div class="col-md-9 col-xl-8">
                                        ...
                                        <input name="image" type="file" onchange="changeImg(this)"
                                            class="image form-control-file" style="display: none;" value="{{$user->avatar ?? 'default-avatar.jpg'}}">
                                    ...
                                    <div class="col-md-9 col-xl-8">
                                        ...
                                        @if (count($errors) > 0)
                                            @if($errors->has("postcode_zip"))
                                                <ul>
                                                    @foreach ($errors->get('postcode_zip') as $message)
                                                        <li style="color:red">{{ $message }}</li>
                                                    @endforeach
                                                </ul>
                                            @endif
                                ...
                                <div class="position-relative row form-group">
                                    ...
                                    <div class="col-md-9 col-xl-8">
                                        <select required name="level" id="level" class="form-control">
                                            ...
                                            @foreach(\App\Ultities\Constants::$user_level as $key => $value)
                                ...
                                <div class="position-relative row form-group mb-1">
                                    <div class="col-md-9 col-xl-8 offset-md-2">
                                        <a href="{{route('UserManager')}}" class="border-0 btn btn-outline-danger mr-1">
